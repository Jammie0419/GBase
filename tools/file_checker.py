...
async def file_hash(path: str, algorithm: str = "sha256") -> dict:
    ...
    cmd = [sys.executable, script, "--action", "hash", "--file", path, "--algorithm", algorithm]
...
async def file_verify(path: str, hash_value: str, algorithm: str = "sha256") -> dict:
    ...
    """
    script = _build_skill_path()
    cmd = [sys.executable, script, "--action", "verify", "--file", path, "--hash", hash_value, "--algorithm", algorithm]
