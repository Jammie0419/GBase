...
<p align="center">
  <a href="https://github.com/garyqlin/gbase/releases/tag/v0.7.0">
    <img src="https://img.shields.io/badge/v0.7.0-🛡️_Cross-platform._Cognitive_+DAG._27_modules.-8A2BE2?style=for-the-badge" alt="v0.7.0">
  </a>
</p>
...
<img src="https://img.shields.io/badge/🖥️-Windows_%7C_macOS_%7C_Linux-0078D4" alt="Platforms">
</p>
...
| 🎛 **Editions** | Hacker / Prime / Standard / Lite — one codebase, different feature sets. HACKER edition has 27 modules |
| 🖥️ **Cross-Platform** | Runs on Windows, macOS, and Linux via `lib/compat.py`. No `python3`, `/tmp`, or `lsof` assumptions |
...
> 🖥️ **Cross-platform**: GBase 0.7.0 runs natively on Windows, macOS, and Linux.
> On Windows, all system calls are abstracted through `lib/compat.py` — no WSL or Cygwin required.
...
│   ├── experience.py    # Anti-fragile experience engine (v2.2)
...
│   ├── dag_engine.py    # 🆕 DAG workflow orchestration (744 lines)
│   ├── dag_orchestrator.py # 🆕 DAG-first task routing (464 lines)
│   ├── dag_agents.py    # 🆕 Agent function library for DAG steps
│   ├── evolution_engine.py # 🆕 Auto-evaluate + auto-rollback
│   ├── skill_router.py  # 🆕 Automatic skill matching
│   ├── loop_cache.py    # 🆕 Tool call pattern learning
│   ├── village_connector.py # 🆕 Village OS multi-agent comms
│   ├── battle_protocol.py  # 🆕 Inter-agent task protocol
│   ├── thinking/        # 🆕 Thinking Lever L0-L4 middleware
│   ├── neocortex/       # 🆕 Cognition engine (5 submodules)
│   ├── trace_review.py  # 🆕 Behavior replay analyzer
