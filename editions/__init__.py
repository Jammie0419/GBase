...
MOD_SKILL_ROUTER = "skill_router"  # 技能自动匹配引擎
MOD_LOOP_CACHE = "loop_cache"  # 循环重放缓存
MOD_TRACE_REVIEW = "trace_review"  # 行为复盘分析器
MOD_THINKING_LEVER = "thinking_lever"  # 思考杠杆（认知中间件）
MOD_NEOCORTEX = "neocortex"  # 新皮层（模式扫描 + 知识蒸馏）
MOD_KNOWLEDGE_MGMT = "knowledge_mgmt"  # 知识管理（km_base/graph/tools）
MOD_BATTLE_PROTOCOL = "battle_protocol"  # Agent 间通信协议
MOD_PIPELINE = "pipeline"  # 门控工作流系统
MOD_MONITOR = "monitor"  # Agent 健康监控
